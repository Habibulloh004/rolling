...
export const metadata = {
  ...
  description:
    "🍣 Лучшее меню суши и роллов в Ташкенте! Выбирайте из классических, запечённых и горячих роллов, WOK, сетов и эксклюзивных новинок. 🚀 Бесплатная доставка по акции или за 40 минут – либо ролл в подарок! 🎁 Бонусная система до 30% кешбэка. rolling.uz – закажите сейчас!",
  keywords:
...
export default async function Page({ params, searchParams }) {
  ...
  return (
    <Container className="w-full sm:w-11/12 flex flex-col pt-5 gap-5">
