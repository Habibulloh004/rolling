...
export const metadata = {
  ...
  description:
    "🔥 Популярные хиты и свежие новинки Rolling Sushi! 🍣 Лучшие классические, запечённые и горячие роллы, WOK и эксклюзивные блюда от наших шеф-поваров. 🚀 Доставка за 40 минут или ролл в подарок! 🎁 Бонусная система до 10% кешбэка – пробуйте новинки и получайте выгоду! Закажите прямо сейчас – rolling.uz!",
  keywords:
