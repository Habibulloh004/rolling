...
export default function ProfileComponent({ path, locale }) {
  ...
  return (
    <main className="w-full">
      ...
      <section className="pt-6 w-full flex flex-col items-center justify-center lg:items-start">
        <div className="w-full flex justify-between gap-5">
          <article className="w-full lg:w-2/3">
            <div>
              ...
              <div className="flex items-center bg-[#F5F5F5] border-[0.5px] border-[#B9B9BB] rounded-[10px] min-w-[280px] max-w-[454px] pr-7 mt-2 mb-5 h-12">
                <Input
                  id="name"
          ...
          <div className="hidden  lg:flex flex-col gap-y-[15px] w-[337px]">
        ...
        <div className="bg-primary rounded-xl w-full max-w-md h-[220px] flex flex-col justify-between items-center relative py-[5px] mt-5">
