...
const EditAddress = ({ params }) => {
  ...
  //   const map = useMap(); // Access map context
  ...
  const handleFoundLocation = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      (error) => {
        console.error("Joylashuvni aniqlashda xatolik yuz berdi:", error.message);
      ...
      <div className="w-full flex flex-col lg:flex-row my-6 justify-around gap-16">
        ...
        <div className="lg:w-full h-48 lg:h-80 rounded-xl overflow-hidden relative z-0">
          ...
          <Button
            ...
            className="absolute bottom-2 right-2 w-10 h-10 rounded-full bg-primary z-[999]">
            <LocateIcon />
          </Button>
        </div>
