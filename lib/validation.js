...
export const UpdateRegisterValidation = () => {
  ...
  return z.object({
    ...
    password: z.string().min(4, { message: t("password") }),
    birthday: z.any(),
    gender: z.any(),
...
export const UpdateReviewValidation = () => {
  ...
  return z.object({
    ...
    text: z.string().min(1, { message: t("text") }),
  });
};
...
export const UpdateResetPasswordValidation = () => {
  ...
  return z
    .object({
      phone: z.string().min(13, { message: t("phone") }),
      new_password: z.string().min(1, { message: t("password") }),
      confirm_password: z.string().min(1, { message: t("password") }),
    })
    .refine((data) => data.new_password === data.confirm_password, {
      message: t("password_mismatch"), // Ensure this translation key exists in your i18n file
      path: ["confirm_password"], // The path to assign the error
    });
};
